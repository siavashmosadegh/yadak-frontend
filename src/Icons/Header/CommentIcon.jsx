...
function CommentIcon () {
    return (
        ...
        >
            ...
            <path d="M14 19C12.7635 19 11.4022 19.4992 10.1586 20.145C8.16119 21.1821 7.16249 21.7007 6.67035 21.3703C6.1782 21.0398 6.27135 20.0151 6.45766 17.9657L6.5 17.5" stroke="#000000" stroke-width="2" stroke-linecap="round"/>
        </svg>
    );
}

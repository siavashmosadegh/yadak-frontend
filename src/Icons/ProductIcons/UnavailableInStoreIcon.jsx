...
function UnavailableInStoreIcon () {
    return (
        <svg 
            width="35px"
            height="35px"
...
export default UnavailableInStoreIcon;